...
const projectSubjects: Array<{ id: "project_math" | "project_language" | "project_science" | "project_english"; criteriaId: "project_math_criteria" | "project_language_criteria" | "project_science_criteria" | "project_english_criteria"; label: string; icon: string }> = [
  { id: "project_math", criteriaId: "project_math_criteria", label: "Matemáticas", icon: "123" },
  { id: "project_language", criteriaId: "project_language_criteria", label: "Lengua", icon: "📖" },
  { id: "project_science", criteriaId: "project_science_criteria", label: "Conocimiento", icon: "🌍" },
  { id: "project_english", criteriaId: "project_english_criteria", label: "Inglés", icon: "ABC" },
];
