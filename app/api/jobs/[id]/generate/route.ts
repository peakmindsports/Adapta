...
export async function POST(request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const content: any[] = [{ type: "input_text", text: job.kind === "adaptation" ? adaptationPrompt(job, String(body.notes || "") + personalContext) : projectPrompt(job, String(body.notes || "") + projectPersonalContext + adaptedProjectContext, body.theme || "", body.duration || "") }];
